...
";
													...
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='SmodifierStagiaire.php?idStagiaire=".$idStagiaire."' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Modifier'><i class='fa fa-edit'></i></a>

														
														
														<a href='Ssupprimerstagiaire.php?idStagiaire=".$idStagiaire."' class='btn btn-xs btn-red tooltips' data-placement='top' data-original-title='Supprimer'><i class='fa fa-times fa fa-white'></i></a>

							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Liste <span class="text-bold">Abscence</span></h4>
									...
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
											...
											<?php
													...
													if(count($errors) == 0){
													$req="SELECT * FROM absence, stagiaire WHERE absence.idStagiaire = stagiaire.idStagiaire";
													...
													while($tabres=mysqli_fetch_assoc($res)){
														...
														$justification=$tabres['justification'];
														$idAbsence=$tabres['idAbsence'];
													...
													<td class='center'>".$justification."</td>
													<td class='center'>
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='supprimerabscence.php?idAbsence=".$idAbsence."' class='btn btn-xs btn-red tooltips' data-placement='top' data-original-title='Supprimer'><i class='fa fa-times fa fa-white'></i></a>
													</div>
													</td>
												</tr>";
															}

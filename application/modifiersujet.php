...
$req2 = "SELECT * FROM `sujet` WHERE `idSujet`='$idSujet'";
...
$Description=$_POST['Description'];
	...
	$req ="UPDATE `sujet` SET `titreSujet`='$titre',`descriptionSujet`='$Description' WHERE `idSujet`='$idSujet'";
	
	$res=mysqli_query($conn,$req);
	echo "<script type='text/javascript'>alert('Le Sujet est Modifier ');
...
<html lang="en">
	...
	<body>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Modifier <span class="text-bold">Sujet</span></h4>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															Titre du sujet <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Entrer le Nom du stagiaire " class="form-control" id="titre" name="titre" value="<?php echo $tab2['titreSujet'];  ?>">
													</div>
													<div class="form-group">
														<label class="control-label">
													...
													<div class="form-group">
														...
														<textarea placeholder="Description du sujet" class="form-control"  id="Description" name="Description" ></textarea>
													</div>
		...
		<script src="assets/js/ajoutersujet.js"></script>

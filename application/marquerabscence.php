...
<html lang="en">
	...
	<body>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Marquer <span class="text-bold">absence</span></h4>
										
									</div>
									<div class="panel-body">
										
									<form action="ajouterabscence.php" role="form" id="form" method="post">
											<div class="row">
												<div class="col-md-12">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label">
															Stagiaire abcsents<span class="symbol required"></span>
														</label>
													...
													if(count($errors) == 0){
													$req4="SELECT * FROM stagiaire WHERE stagiaire.etat = 'affecter'";
													$res4=mysqli_query($conn,$req4);
													if($res4 && $number4=mysqli_num_rows($res4)>0){
														while($tabres4=mysqli_fetch_assoc($res4)){
														$nomstgi=$tabres4['nom'];
														$idstgi=$tabres4['idStagiaire'];

														$req5="SELECT * FROM `absence` WHERE `idStagiaire` = '$idstgi'";
													$res5=mysqli_query($conn,$req5);
													$tabress=mysqli_fetch_assoc($res5);
													$dateFinn=$tabress['dateFin'];
													$dat = new DateTime();
													$datsys = $dat->format('Y-m-d');

													if($datsys > $dateFinn ){

														$sel4.="<option value='$idstgi'>".$nomstgi."</option>";
													...
													<div class="form-group connected-group">
														<label class="control-label">
															Début d'absence <span class="symbol required"></span>
														</label>
														<div class="row">
															<div class="col-md-3">
													...
													<div class="form-group connected-group">
														<label class="control-label">
															Fin d'absence <span class="symbol required"></span>
														</label>
														<div class="row">
															<div class="col-md-3">
													...
													<div class="form-group">
														<label class="control-label">
															Justification <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Entrer le type de la justification" class="form-control" id="justification" name="justification">
													</div>	
												</div>
		...
		<script src="assets/js/ajouterabscence.js"></script>

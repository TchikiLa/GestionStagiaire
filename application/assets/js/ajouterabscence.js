var FormValidator = function () {
    ...
    var runValidator1 = function () {
        ...
        $.validator.addMethod("inferieur", function () {
            ...
            if (($("#dd").val() < $("#dd1").val()) && $("#mm").val() == $("#mm1").val() &&  $("#yyyy").val() == $("#yyyy1").val() ) {
             return true;
              }else if($("#mm").val() < $("#mm1").val() &&  $("#yyyy").val() == $("#yyyy1").val() ){
                return true;
              }else if($("#yyyy").val() < $("#yyyy1").val()){
                return true;
              }else {return false }
        }, "Date postérieur à la date de debut d'absence ");
        $('#form').validate({
            ...
            errorPlacement: function (error, element) { // render error placement for each input type
                ...
                } else if (element.attr("name") == "dd1" || element.attr("name") == "mm1" || element.attr("name") == "yyyy1") {
                    error.insertAfter($(element).closest('.form-group').children('div'));
                } else {
            ...
            groups: {
                datenaiss: "dd mm yyyy",
                datedepot: "dd1 mm1 yyyy1",
            },

							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Stagiaire <span class="text-bold">Affeecter</span></h4>
...
";
													...
													$req="SELECT * FROM stage , stagiaire , tuteur , sujet WHERE stage.idStagiaire = stagiaire.idStagiaire AND stage.idTut = tuteur.idTut AND stage.idSujet = sujet.idSujet AND stagiaire.etat = 'affecter'";
													...
													while($tabress=mysqli_fetch_assoc($res)){
														...
														$denominationOrganisme=$tabress['denominationOrganisme'];
														$libelleSpecialite=$tabress['libelleSpecialite'];
														$nomTut=$tabress['nomTut'];
													...
													<td>".$adress."</td>
													<td>".$niveau."</td>
													<td>".$denominationOrganisme."</td>
													<td>".$libelleSpecialite."</td>
													<td>".$nomTut."</td>
													<td>".$titreSujet."</td>
													<td>".$dateDeb."</td>
													<td>".$dateFin."</td>

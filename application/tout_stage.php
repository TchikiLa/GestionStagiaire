							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Liste <span class="text-bold">des Stages</span></h4>
									...
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
											...
											<?php
													...
													if(count($errors) == 0){
													$req="SELECT * FROM stage , tuteur , stagiaire , sujet WHERE stage.idStagiaire = stagiaire.idStagiaire AND tuteur.idTut = stage.idTut AND stage.idSujet = sujet.idSujet";
													$res=mysqli_query($conn,$req);
													$tab="<tbody>";
													while($tabres=mysqli_fetch_assoc($res)){
														$nom=$tabres['nom'];
														$nomTut=$tabres['nomTut'];
														$dateDeb=$tabres['dateDeb'];
														$dateFin=$tabres['dateFin'];
														$idStage=$tabres['idStage'];
														$titre=$tabres['titreSujet'];
		
														
														$tab.="<tr>
													<td class='center'>".$nom."</td>
													<td class='center'>".$nomTut."</td>
													<td class='center'>".$titre."</td>
													<td class='center'>".$dateDeb."</td>
													<td class='center'>".$dateFin."</td>
													<td class='center'>
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='modifierstage.php?idStage=".$idStage."' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Modifier'><i class='fa fa-edit'></i></a>
														
														<a href='supprimerstage.php?idStage=".$idStage."' class='btn btn-xs btn-red tooltips' data-placement='top' data-original-title='Supprimer'><i class='fa fa-times fa fa-white'></i></a>
													</div>
													</td>
												</tr>";
															}

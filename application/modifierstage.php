...
$req0 = "SELECT * FROM stage WHERE `idStage`='$idStage'";
$res0=mysqli_query($conn,$req0);
$tab0=mysqli_fetch_assoc($res0);
$iddstgg = $tab0['idStagiaire'];
$iddsujett = $tab0['idSujet'];
$iddtutt = $tab0['idTut'];
...
$moisn = $_POST['mm'];
$annen = $_POST['yyyy'];
$datedeb=$annen.'-'.$moisn.'-'.$journ;

$journ1 = $_POST['dd1'];
$moisn1 = $_POST['mm1'];
$annen1 = $_POST['yyyy1'];
$datefin=$annen1.'-'.$moisn1.'-'.$journ1;



						$req6="SELECT * FROM `stage` WHERE `idSujet`='$Sujet'";

						$res6=mysqli_query($conn,$req6);
						if($res6 && $number6=mysqli_num_rows($res6)>0){
							while($tabres6=mysqli_fetch_assoc($res6)){

							$idStagiaireee=$tabres6['idStagiaire'];
							$req7="UPDATE `stage` SET `idSujet`='$Sujet',`idTut`='$Tuteur',`dateDeb`='$datedeb',`dateFin`='$datefin' WHERE `idStagiaire`='$idStagiaireee'";
							$res7=mysqli_query($conn,$req7);

								}
							}  
	echo "<script type='text/javascript'>alert('Le stage est Modifier ');
...
<html lang="en">
	...
	<body>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Modifier <span class="text-bold">Affectation</span></h4>
										...
										<form  role="form" id="form" method="post">
											<div class="row">
												...
												<div class="col-md-6">
													...
													$req1="SELECT * FROM stagiaire WHERE `idStagiaire`='$iddstgg'";
													...
													if($res1 && $number1=mysqli_num_rows($res1)>0){
														...
														$sel1.="<option value='$idstg' selected>".$nomstg."</option>";
															}
														}  
													echo $sel1;
													...
													if($res2 && $number2=mysqli_num_rows($res2)>0){
														...
														$req4 = "SELECT * FROM `sujet` WHERE `idSujet`='$iddsujett'";
														$res4=mysqli_query($conn,$req4);
														$tab4=mysqli_fetch_assoc($res4);
														$nommsujett = $tab4['titreSujet'];
														$sel2.="<option value='$iddsujett' selected>".$nommsujett."</option>";
													echo $sel2;
													...
													$req5 = "SELECT * FROM `tuteur` WHERE `idTut`='$iddtutt'";
														$res5=mysqli_query($conn,$req5);
														$tab5=mysqli_fetch_assoc($res5);
														$nommtutt = $tab5['nomTut'];
													$req3="SELECT * FROM `tuteur` WHERE `etat` <=4";
													...
													if($res3 && $number3=mysqli_num_rows($res3)>0){
														...
														if($idtut == $iddtutt){
															$sel3.="<option value='$iddtutt' selected>".$nommtutt."</option>";
														}else{
		...
		<script src="assets/js/modifierstage.js"></script>

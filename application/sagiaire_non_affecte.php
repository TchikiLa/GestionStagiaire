							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Stagiaire <span class="text-bold">Non affeecter</span></h4>
...
";
													...
													$req="SELECT * FROM `stagiaire` WHERE `idStagiaire` NOT IN (SELECT `idStagiaire` FROM `stage`)";
													...
													while($tabress=mysqli_fetch_assoc($res)){
														...
														$adressOrganisme=$tabress['adressOrganisme'];
													...
													<td>".$adressOrganisme."</td>
													<td>".$libelleSpecialite."</td>
													<td>".$dateDepot."</td>
													<td class='center'>
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='modifierStagiaire.php?idStagiaire=".$idStagiaire."' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Modifier'><i class='fa fa-edit'></i></a>

														
														
														<a href='supprimerstagiaire.php?idStagiaire=".$idStagiaire."' class='btn btn-xs btn-red tooltips' data-placement='top' data-original-title='Supprimer'><i class='fa fa-times fa fa-white'></i></a>

...
$idstagiairee3=$_POST['stagiaire3'];
...
$etattutt= $etattutt + 3;
	...
	$req7="INSERT INTO `stage`(`idStage`, `idStagiaire`, `idSujet`, `idTut`, `dateDeb`, `dateFin`) VALUES (NULL,'$idstagiairee3','$idsujete','$idTute','$datedebute','$datefine')";
	$res7=mysqli_query($conn,$req7);
		...
		$req5 = "UPDATE `stagiaire` SET `etat`= '$etate' WHERE stagiaire.idStagiaire= '$idstagiairee3'";
		$res5=mysqli_query($conn,$req5);

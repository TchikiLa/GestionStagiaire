							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Liste <span class="text-bold">Tuteurs libre</span></h4>
...
";
													...
													$req="SELECT * FROM `tuteur` WHERE `etat` <= 0";
													$res=mysqli_query($conn,$req);
													$tab="<tbody>";
													while($tabress=mysqli_fetch_assoc($res)){
														$idTut=$tabress['idTut'];
														$nomTut=$tabress['nomTut'];
														$prenomTut=$tabress['prenomTut'];
														$emailTut=$tabress['emailTut'];
														$telTut=$tabress['telTut'];
														$libelleDep=$tabress['libelleDep'];
														$specialite=$tabress['specialite'];
													...
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='modifiertuteur.php?idTut=".$idTut."' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Modifier'><i class='fa fa-edit'></i></a>
														
														<a href='supprimertut.php?idTut=".$idTut."' class='btn btn-xs btn-red tooltips' data-placement='top' data-original-title='Supprimer'><i class='fa fa-times fa fa-white'></i></a>
													</div>
													</td>
												</tr>";
															}

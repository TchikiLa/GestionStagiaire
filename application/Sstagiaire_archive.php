									...
									<ul class="nav navbar-right">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-light dropdown-subview">
												...
												<li>
													<a href="Smarquerabscence.html" class="new-event"><span class="fa-stack"> <i class="fa fa-calendar-o fa-stack-1x fa-lg"></i> <i class="fa fa-plus fa-stack-1x stack-right-bottom text-danger"></i> </span> Marquer abscence</a>
												</li>
												...
												<li>
													<a href="Stout_stagiaire.html" class="show-contributors"><span class="fa-stack"> <i class="fa fa-user fa-stack-1x fa-lg"></i> <i class="fa fa-share fa-stack-1x stack-right-bottom text-danger"></i> </span> Liste stagiaire</a>
												</li>
											</ul>
										</li>
										<li class="dropdown">
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Liste <span class="text-bold">Stagiaire</span></h4>
									...
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
											...
											<?php
													...
													$req1="SELECT tuteur.etat,tuteur.idTut,stage.dateFin,stagiaire.idStagiaire,stagiaire.etat AS etatt FROM stage , stagiaire , tuteur , sujet WHERE stage.idStagiaire = stagiaire.idStagiaire AND stage.idTut = tuteur.idTut AND stage.idSujet = sujet.idSujet
";
													...
													while($tabress1=mysqli_fetch_assoc($res1)){
														...
														$idtutt = $tabress1['idTut'];
														$etattutt = $tabress1['etat'];
														$etatstgg = $tabress1['etatt'];
														if(strtotime($datsys) > strtotime($dateFinn) && ($etatstgg != 'archive')){
															$archive = "UPDATE `stagiaire` SET `etat`='archive' WHERE `idStagiaire` = '$idStagiairearchv'";
															$archivee=mysqli_query($conn,$archive);
															$etattutt = $etattutt - 1;
															$udtetattut = "UPDATE `tuteur` SET `etat`= '$etattutt' WHERE tuteur.idTut= '$idtutt'";
															$resetat=mysqli_query($conn,$udtetattut);
														}
													}

													$req="SELECT * FROM stage , stagiaire , tuteur , sujet WHERE stage.idStagiaire = stagiaire.idStagiaire AND stage.idTut = tuteur.idTut AND stage.idSujet = sujet.idSujet AND stagiaire.etat = 'archive'";
													$res=mysqli_query($conn,$req);
													$tab="<tbody>";
													while($tabress=mysqli_fetch_assoc($res)){
														$idStagiaire=$tabress['idStagiaire'];
														$nom=$tabress['nom'];
														$prenom=$tabress['prenom'];
														$dateNaissance=$tabress['dateNaissance'];
														$sexe=$tabress['sexe'];
														$email=$tabress['email'];
														$tel=$tabress['tel'];
														$adress=$tabress['adress'];
														$niveau=$tabress['niveau'];
														$typeStage=$tabress['typeStage'];
														$dateDepot=$tabress['dateDepot'];
														$titreSujet=$tabress['titreSujet'];
													...
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='pdf.php?idStagiaire=".$idStagiaire."' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Imprimer'><i class='fa fa-print'></i></a>

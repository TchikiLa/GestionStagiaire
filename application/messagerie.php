				...
				<div class="navbar-content">
					...
					<div class="main-navigation left-wrapper transition-left">
						...
						<ul class="main-navigation-menu">
							...
							<li>
								<a href="#"><i class="fa fa-envelope"></i> <span class="title">Envoyer email</span> </a>
							</li>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Ajouter <span class="text-bold">Stagiair</span></h4>
										
									</div>
									<div class="panel-body">
										
										<form action="message.php" role="form" id="form" method="post" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-12">
												...
												<div class="col-md-6">
													...
													$res4=mysqli_query($conn,$req4);
														...
														$sel4.="<option value='$email'>".$nomstgi."</option>";
															}
												...
												<div class="form-group">
													...
													<textarea placeholder="Entrer le message à envoyer " id="form-field-22" class="form-control" id="message" name="message"></textarea>
												</div>

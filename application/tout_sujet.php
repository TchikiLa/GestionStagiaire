							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Liste <span class="text-bold">des Sujets</span></h4>
									...
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
											...
											<?php
													...
													$tab="<tbody>";
													while($tabres=mysqli_fetch_assoc($res)){
														$titreSujet=$tabres['titreSujet'];
														$descriptionSujet=$tabres['descriptionSujet'];
														$idSujet=$tabres['idSujet'];
														$typeStage=$tabres['typeStage'];
														$specialite=$tabres['specialite'];
														$req3="SELECT * FROM `stage` WHERE `idSujet` ='$idSujet'";
														$res3=mysqli_query($conn,$req3);
														$n =mysqli_num_rows($res3);
														if($n >0){$etat = "pris";}else $etat ="Non pris";
														
														$tab.="<tr>
													<td class='center'>".$titreSujet."</td>
													<td class='center'>".$descriptionSujet."</td>
													<td class='center'>".$specialite."</td>
													<td class='center'>".$typeStage."</td>
													<td class='center'>".$etat."</td>
													<td class='center'>
													<div class='visible-md visible-lg hidden-sm hidden-xs'>
														<a href='modifiersujet.php?idSujet=".$idSujet."' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Modifier'><i class='fa fa-edit'></i></a>
														
														<a href='supprimersujet.php?idSujet=".$idSujet."' class='btn btn-xs btn-red tooltips' data-placement='top' data-original-title='Supprimer'><i class='fa fa-times fa fa-white'></i></a>
													</div>
													</td>
												</tr>"; 
															}

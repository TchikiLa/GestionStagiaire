...
$idTut=$_GET['idTut'];
$req2 = "SELECT * FROM `tuteur` WHERE `idTut`='$idTut'";
...
$libelleDepp=$_POST['departement'];
	...
	$req="UPDATE `tuteur` SET `nomTut`='$nomTut',`prenomTut`='$prenomTut',`emailTut`='$emailTut',`telTut`='$telTut',`libelleDep`='$libelleDepp',`specialite`='$specialitee' WHERE tuteur.idTut='$idTut'";
	$res=mysqli_query($conn,$req);
	header('location: tout_tuteur.php');
	echo "<script type='text/javascript'>alert('Le Tuteur est Modifier ');
...
<html lang="en">
	...
	<body>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Modifier <span class="text-bold">Tuteur</span></h4>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" placeholder="Entrer le Nom du Tuteur " class="form-control" id="nom" name="nom" value="<?php echo $tab2['nomTut'];  ?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Prénom <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Entrer le prénom du Tuteur " class="form-control" id="prenom" name="prenom" value="<?php echo $tab2['prenomTut'];  ?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Address Email <span class="symbol required"></span>
														</label>
														<input type="email" placeholder="Entrer l'adress email du Tuteur" class="form-control" id="email" name="email" value="<?php echo $tab2['emailTut'];  ?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Tel <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Entrer le numéro de téléphone du Tuteur" class="form-control" id="tel" name="tel" value="<?php echo $tab2['telTut'];  ?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Specialite <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Entrer la Spécialite du tuteur" class="form-control" id="specialite" name="specialite" value="<?php echo $tab2['specialite'];  ?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Departement <span class="symbol required"></span>
														</label>
														<select class="form-control" id="departement" name="departement">
															<option value="">sélectionné Departement</option>
		...
		<script src="assets/js/ajoutertuteur.js"></script>
